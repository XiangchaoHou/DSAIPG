...
public class ParSortTest {
    ...
    public void testSortSmallArray() {
        ...
        ParSort.sort(array, 0, array.length, ForkJoinPool.commonPool());
    ...
    public void testSortPartialArray() {
        ...
        ParSort.cutoff = 10;
        ParSort.sort(array, 0, 4, ForkJoinPool.commonPool());
        assertArrayEquals(expected, array);
    }
    ...
    public void testSortNegativeRange() {
        ...
        ParSort.cutoff = 10;
        ParSort.sort(array, -1, 3, ForkJoinPool.commonPool());
    }
    ...
    public void testSortOverlappingRange() {
        ...
        ParSort.cutoff = 10;
        ParSort.sort(array, 0, 3, ForkJoinPool.commonPool());
        assertArrayEquals(expected, array);
    }
}